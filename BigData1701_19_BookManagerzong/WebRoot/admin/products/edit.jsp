...
<script type="text/javascript">
	//设置类别的默认值
	function setProductCategory(t) {//因为js是弱语法，所以参数可以直接写一个名字
		//获取下来列表对象
		...
		for ( var i = 0; i < ops.length; i++) {
			...
			if (ops[i].value == t) {
				ops[i].selected = true;//selected=true是选中的意思
				return;
			}
		}
...
<body onload="setProductCategory('${book.category}')">
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath }/UpdateBookServlet" method="post" style="height: 288px; ">
