		...
		if (cookies!=null) {
			for (int i = 0; i < cookies.length; i++) {
				...
				if ("user1".equals(name)) {
					//解码
					String tempname = cookies[i].getValue();
					value = URLDecoder.decode(tempname,"utf-8");
					//当名字被保存后,记住用户名处于选中状态
												...
												<table width="100%" border="0" cellspacing="0">
													...
													<tr>
														<td style="text-align:center;padding-top:20px;"><font
															color="#ff0000">${requestScope["errmsg"]}</font>
														</td>
													</tr>
													<tr>
															...
															<table width="80%" border="0" cellspacing="0"
																...
																<tr>
																	...
																	<td style="text-align:left"><input name="username"
																		type="text" class="textinput" value="${value }"/>
																...
																<tr>
																	<td colspan="2" style="text-align:center"><input
																		type="checkbox" name="remember" ${check } />
																		记住用户名&nbsp;&nbsp; <input type="checkbox"
																		name="auto" value="checkbox" /> 自动登录</td>
																</tr>
																<tr>
																	<td colspan="2"
