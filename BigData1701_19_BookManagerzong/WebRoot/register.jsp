		   ...
		   //在当前函数的内部,this代表的是email对象
			...
			req.onreadystatechange = function(){
				...
				if(req.status==200  && req.readyState==4){
					...
					//根据服务器返回的值,判断用户名是否符合要求
					if(txt=="true"){
						font.innerHTML = "用户名已存在";
			...
			//2.
			req.open("get", "${pageContext.request.contextPath}/findEmailServlet?email="+emailValue);
					...
					<td style="padding:30px">
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							<tr>
								...
								<td style="width:50%"><input type="text" class="textinput" name="ckcode"/><font color="red">${errmsg }</font>
								</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
