		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<form id="orderForm" action="${pageContext.request.contextPath}/servlet/OrderServlet" method="post">
						<table cellspacing="0" class="infocontent">
							<tr>
								<td><table width="100%" border="0" cellspacing="0">
										<tr>
											<td><img src="images/buy2.gif" width="635" height="38" />
												<p>您好：${user.username }${user.gender=="男"?"先生":"女士" }！欢迎您来到商城结算中心</p></td>
										</tr>
										<tr>
                                           ...
                                           <c:forEach items="${cart }" var="en" varStatus="vs">
												<table width="100%" border="0" cellspacing="0">
													<tr>
														<td width="10%">${vs.count }</td>
														<td width="40%">${en.key.name }</td>
														<td width="10%">${en.key.price }</td>
														<td width="10%">${en.key.category }</td>
														<td width="10%"><input name="text" type="text"
															value="${en.value }" style="width:20px" readonly="readonly" /></td>
														<td width="10%">${en.key.price*en.value }</td>
                                                     
													</tr>
												</table>
												<c:set var="sum" value="${sum+en.key.price*en.value }"></c:set>
                                         		</c:forEach>
