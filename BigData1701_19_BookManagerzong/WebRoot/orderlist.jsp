							...
							<td style="padding:20px"><p>欢迎${user.username }光临商城！</p>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									...
									<tr>
										...
										<td class="tableopentd03"><a href="${pageContext.request.contextPath }/servlet/FindOrderInfoServlet?order_id=${order.id}">查看</a>&nbsp;&nbsp;
											<a href="${pageContext.request.contextPath }/servlet/DeleteOrderInfoServlet?order_id=${order.id}">刪除</a>
										</td>
									</tr>
									</c:forEach>
