									...
									<tr>
										<td width="30%">
											...
											<div class="divbookcover">
												<p>
													<img src="C:/Users/Administrator/Desktop/img/upload/${book.img_url}" width="213" height="269" border="0" />
												</p>
											</div>

											<div style="text-align:center; margin-top:25px">
												<a href="${pageContext.request.contextPath }/servlet/AddToCartServlet?id=${book.id}"> <img src="images/buybutton.gif" border="0" />
												</a>
											</div>
										</td>
