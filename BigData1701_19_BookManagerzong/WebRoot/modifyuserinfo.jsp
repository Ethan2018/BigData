			...
			<tr>
					...
					<table width="100%" border="0" cellspacing="0"
						...
						<tr>
							<td class="listtd"><img src="images/miniicon.gif" width="9"
								height="6" />&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="${pageContext.request.contextPath }/findUserServlet">用户信息修改</a></td>
						</tr>
				...
				<td>
					...
					<table cellspacing="0" class="infocontent">
						<tr>
							<td>
								<form action="${pageContext.request.contextPath }/servlet/ModifyUserServlet" method="post">
									...
									<table width="100%" border="0" cellspacing="2" class="upline">
										...
										<tr>
											...
											<td colspan="2"><input name="telephone" type="text"
												 class="textinput" value="${user.telephone }"/>
											</td>
										</tr>
